...
" Enable filetype plugin to detect programming language in file and apply
" language-specific settings. This also enables language-dependent indenting
" (however, this seems overridden by explicit "set tabstop=2" at the top of
" this file).
